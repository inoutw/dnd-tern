...
const lessRegex = /\.less$/; // add by lc
const lessModuleRegex = /\.module\.less$/; // add by lc
...
module.exports = function (webpackEnv) {
  ...
  return {
    ...
    output: {
      ...
      // publicPath: isEnvProduction ? '/apps/app-react/' : '/', // qiankun
      ...
      // qiankun setting
      jsonpFunction: `webpackJsonp_${appPackageJson.name}`, // qiankun add _
      // this defaults to 'window', but by setting it to 'this' then
      // module chunks which are built will work in web workers as well.
      globalObject: 'window', // qiankun this => window
      library: `${appPackageJson.name}-[name]`, // qiankun +
      libraryTarget: 'umd' // qiankun +
    },
    optimization: {
